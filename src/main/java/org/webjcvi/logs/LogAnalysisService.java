...
public final class LogAnalysisService {
    ...
    public LogAnalysisService() {
        this(new BannerSplitter(), new PairDrift(), new WrapReflow(), new RareClassScanner(),
                ...
                new PhaseJoint(), new FrameFields(), new CloneScan(), new PrefixGroup(), new KeyWidth(), new ForkScan(), new AffixScan(), new LaneScan(), new RowScan(), new CliffScan());
    }
    ...
    public LogAnalysisReport analyze(String text) {
        ...
        var phaseScan = phase.scan(payload);
        var phaseSection = new LogAnalysisReport.PhaseSection(
                phaseScan.scanned(),
                phaseScan.hitCount(),
                phaseScan.wrapWidth(),
                phaseScan.phase(),
        ...
        var rowScan = rows.profile(payload);
        var rowSection = new LogAnalysisReport.RowSection(
                rowScan.lineCount(),
                rowScan.scanned(),
                rowScan.tileLength(),
                rowScan.uniqueAt(),
                rowScan.uniqueShareAt16(),
                rowScan.twinCount(),
                rowScan.twinLines(),
                rowScan.topPrefix(),
                rowScan.topCount());

        var cliffScan = cliffs.profile(payload);
        var cliffSection = new LogAnalysisReport.CliffSection(
                cliffScan.lineCount(),
                cliffScan.scanned(),
                cliffScan.tileLength(),
                cliffScan.forkAt(),
                cliffScan.cliffAt(),
                cliffScan.shareAt16(),
                cliffScan.shareAtCliff(),
                cliffScan.topPrefix(),
                cliffScan.topCount());
        ...
        LogAnalysisReport report = new LogAnalysisReport(
                ...
                cliffSection);
        if (log.isDebugEnabled()) {
            log.debug("log-analysis.done truncated={} tapeRuns={} banners={} hotspots={} tokens={} stamps={} palindromes={} spans={} fuzzyHits={} stutters={} mirrors={} seams={} phase={} fields={} clones={} prefixes={} keys={} forks={} affixes={} lanes={} rows={} cliffs={}",
                    truncated,
