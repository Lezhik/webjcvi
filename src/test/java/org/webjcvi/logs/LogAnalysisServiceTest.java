...
class LogAnalysisServiceTest {
    ...
    private static final List<String> DUP_KEYS = List.of(
            "lineCount", "scanned", "floorLength", "nearAt", "shareAtNear",
    ...
    private static final List<String> PREFIX_KEYS = List.of(
            "scanned", "distinct", "familyCount", "familyFrames", "topCount", "topPrefix", "wrapWidth", "prefixLength");
    private static final List<String> KEY_KEYS = List.of(
    ...
    private static final List<String> LANE_KEYS = List.of(
            "scanned", "wrapWidth", "tileLength", "troughAt", "peakAt", "troughShare", "peakShare", "spread");
